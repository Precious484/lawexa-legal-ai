                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 ${
                    index === 0
                      ...
                      : 'bg-white text-gray-600 hover:bg-lawexa-gold hover:text-black border border-gray-200'
                  }`}
                >
                  {category}
                </button>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogPosts.map((post, index) => (
                <article key={index} className="bg-white rounded-2xl overflow-hidden shadow-medium hover:shadow-large transition-all duration-300 hover:-translate-y-2">
                  <img 
                    src={post.image} 
                    alt={post.title}
            ...
            <div className="text-center mt-12">
              <button className="bg-lawexa-gold text-black px-8 py-3 rounded-xl font-bold hover:bg-lawexa-gold/90 hover:scale-105 transition-all duration-300">
                Load More Articles
              </button>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="max-w-md mx-auto flex gap-4">
              <input 
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-lawexa-gold"
              />
              <button className="bg-lawexa-gold text-black px-6 py-3 rounded-xl font-bold hover:bg-lawexa-gold/90 transition-colors duration-300">
                Subscribe
              </button>
            </div>
