...
const PricingSection = () => {
  const plans = [{
    ...
    features: ['Ask a questions About Nigeria Cases', 'Download cases', 'Convert Image/files to notes', 'Create Basic Flashcards', 'Limited Chat with legal documents', 'Access to Lawexa Student Kit', 'Lawexa Questions bank', 'Questions from practice', 'Lawexa Student Archive', 'Create forms & Wills Materials', 'Connect to Law students Nearby', 'LawBreakers', 'Limited Smart Legal Assistant Access'],
    ...
    features: ['Everything in Free, PLUS:', 'Perfect for Law students who want everything to excel academically and pass', 'Unlimited smart legal guidance', 'Course Notes & Slide Materials', 'Understand the Principles, Parties and court Rulings', 'Lawexa Questions bank', 'Questions from past Questions, Text Book and case law', 'LawBreakers Quiz'],
    ...
    features: ['Perfect for Professionals', 'Entrepreneurs, Business owners', 'Everything In Student, PLUS:', 'Document Risk Assessment', 'Contract Clause Analysis', 'Legal Advice Recommendation', 'Priority Support (Response in 1 hours)', 'AI Legal Content Generator', 'Perfect AI Tutor', 'Content Legal Claims'],
    ...
    features: ['Perfect for Advising teams who need unlimited access', 'Everything In Assistant, PLUS:', 'Up to 15 user Accounts', 'Document Database & Analytics', 'AI-Powered Case Management', 'More Legal & Business Features', 'Custom Team Training Session', 'We come for Business consultation call', 'Our Legal Specialist Dedicated Account Manager'],
  ...
  return <section className="py-20 bg-lawexa-dark text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {plans.map((plan, index) => <div key={plan.name} className={`relative bg-gray-900 rounded-2xl p-6 ${plan.popular ? 'ring-2 ring-primary' : ''} hover:scale-105 transition-transform duration-300`}>
