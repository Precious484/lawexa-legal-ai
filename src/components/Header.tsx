      ...
      <div className="container mx-auto px-4 bg-slate-950">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="outline" className={`transition-colors duration-300 ${isScrolled ? 'bg-transparent border-foreground text-foreground hover:bg-foreground hover:text-white' : 'bg-transparent border-white text-white hover:bg-white hover:text-black hover:border-white'}`} onClick={() => window.open('https://app.lawexa.com/login', '_blank')}>
              Log in
            </Button>
            <Button className="btn-gold" onClick={() => window.open('https://app.lawexa.com/register', '_blank')}>
              Sign Up
            </Button>
          </div>
        ...
        {isMenuOpen && <div className="md:hidden bg-white border-t border-border">
            ...
            setTimeout(() => window.scrollTo(0, 0), 100);
              ...
              <div className="flex flex-col space-y-3 pt-4 border-t border-border">
                <Button variant="outline" className="w-full border-foreground text-foreground hover:bg-foreground hover:text-white" onClick={() => {
              setIsMenuOpen(false);
