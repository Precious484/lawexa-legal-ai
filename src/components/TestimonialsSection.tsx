...
const TestimonialsSection = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'Lawyer': return 'bg-primary/10 text-primary';
    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white rounded-full p-3 shadow-medium hover:shadow-large transition-all duration-300"
          >
            <ChevronLeft className="w-6 h-6 text-gray-600" />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white rounded-full p-3 shadow-medium hover:shadow-large transition-all duration-300"
          >
